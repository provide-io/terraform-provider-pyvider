# Function: to_kebab_case - utility_functions Example

This directory contains a complete, executable Terraform example demonstrating the `to_kebab_case` function.
