# Function: pluralize - Complete Examples

This directory contains a comprehensive Terraform example demonstrating all capabilities of the `pluralize` function.
