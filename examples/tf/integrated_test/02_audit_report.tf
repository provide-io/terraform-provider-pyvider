# This file executes the master audit query using the `pyvider_jq_cty` data source.

data "pyvider_jq_cty" "full_system_audit" {
...
output "psycho_structural_materials_audit_report" {
  ...
  value       = data.pyvider_jq_cty.full_system_audit.result
}
