---
page_title: "Tour the Example Provider"
...
- Follow the [getting started guide](./getting-started.md) to run a complete example.
- Review [common patterns](./common-patterns.md) once you are comfortable with the basics.
- Ready to build something custom? Visit [Plan your own provider](./build-your-own-provider.md).
