...
- Take a [tour of the example provider](./provider-tour.md) to understand what is shipped.
- Jump into the [getting started tutorial](./getting-started.md) when you want to run Terraform locally.
- Keep the [common patterns guide](./common-patterns.md) handy as you tinker.
